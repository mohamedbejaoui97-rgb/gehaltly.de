...
import { type CalculatorResult as CalculatorResultType, type CalculatorInput, calculateGermanTax } from "@/lib/tax";
...
export default function NettoBruttoRechnerPage() {
  ...
  const [wunschSteuerklasse, setWunschSteuerklasse] = useState<number>(1);
  const [wunschBundesland, setWunschBundesland] = useState<string>("Nordrhein-Westfalen");
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <Select
                            ...
                            onValueChange={(value) => setWunschSteuerklasse(parseInt(value))}
                          >
                        ...
                        <div>
                          ...
                          <Select
                            ...
                            onValueChange={setWunschBundesland}
                          >
